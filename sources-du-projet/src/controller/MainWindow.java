...
public class MainWindow implements Observateur{
	...
	public void initialize() throws IOException {
		...
		//Liste des fichier lus
		fichiersLus = new ArrayList<>();
	...
	public void buttonPressedAboutUs() {
		 Alert informationsApp = new Alert(Alert.AlertType.INFORMATION);
		 informationsApp.setTitle("Informations !");
		 informationsApp.setContentText("");
		 informationsApp.setHeaderText("");
		 informationsApp.showAndWait();
	}
